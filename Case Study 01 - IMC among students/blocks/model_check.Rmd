...
The result of the Fligner-Killeen test below shows that both distribution an equal variance on it's population.
...
stripchart(x = resid_m2016_17, vertical = TRUE,pch = 16,cex = 1.5,las = 1,xlab = "mean",ylab = "residuals")
