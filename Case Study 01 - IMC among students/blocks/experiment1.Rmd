The first experiment's null hypothesis explicits that there is no difference between man or woman BMI means, given that this indicator doesn't incorporates genre in its calculation. Therefore, our alternative hypothesis is that is some difference between genre that reflects into how the means varies.
$$
