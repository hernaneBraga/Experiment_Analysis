...
Como a proposta do estudo é de comparar como as modificações impactam nos resultados, utiliza-se o valor médio de . Portanto, a primeira hipótese é de comparar se os valores médios de cada uma das configurações são iguais, ou seja:
...
Para a hipóteses, utiliza-se um mínimo de importância prática de $0,5$, um índice de significância de $\alpha = 0,05$ e potência mínima desejada de $\beta = 0.8$.